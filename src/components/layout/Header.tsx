...
interface HeaderProps {
  ...
  children?: React.ReactNode  // Tambahkan children untuk NotificationBell
}

export default function Header({ toggleSidebar, isSidebarOpen, children }: HeaderProps) {
        ...
        <div className="flex justify-between items-center h-16">
          ...
          <div className="flex items-center gap-4">
            ...
            {toggleSidebar && (
              ...
              >
                <Menu className={`h-5 w-5 transition-transform duration-300 ${isSidebarOpen ? 'rotate-90' : ''}`} />
              </button>
            )}
          ...
          <div className="flex items-center gap-2 sm:gap-3">
            ...
            {/* Notification Bell - menggunakan children */}
            {children}
            ...
            <div className="relative">
              ...
              >
                ...
                <ChevronDown className={`hidden sm:block h-4 w-4 text-gray-400 transition-transform duration-200 ${showUserMenu ? 'rotate-180' : ''}`} />
              </button>
                    ...
                    <div className="p-4 bg-linear-to-r from-gray-800 to-gray-750 border-b border-gray-700">
                      ...
                      <p className="text-xs text-emerald-400 mt-2">
                        {profile?.role === 'admin' ? 'Administrator' : 
                         profile?.role === 'petugas' ? 'Petugas Lapangan' : 'Pengguna'}
                      </p>
                    </div>
